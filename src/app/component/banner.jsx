...
export default function Banner (){
  ...
  return (
    ...
    >
      <Link href= "/"className=" hover:underline  sm:max-w-lg text-xl font font-extrabold tracking-tight text-gray-900 sm:text-6xl text-center " >  L' Antonia sin tacc </Link>
